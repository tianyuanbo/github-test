...
$form = ActiveForm::begin([
    'action' => 'index.php?r=login/insert',
    'method' => 'post',
]) ?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">蜗牛短租</span>
									<span class="white">后台管理系统</span>
								</h1>
								<h4 class="blue">&copy; 蜗牛科技股份有限责任公司</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="u_name" id="u_name" class="form-control" placeholder="用户名" onblur="check_name()"/>
                                                            <span id="s_name"></span>
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="u_pwd" id="u_pwd" class="form-control" placeholder="密码" onblur="check_pwd()"/>
                                                            <span id="s_pwd"></span>
															<i class="icon-lock"></i>
														</span>
													</label>
													...
													<div class="clearfix">
														...
														<button type="submit" id="sp" class="width-35 pull-right btn btn-sm btn-primary">
															<i class="icon-key"></i>
															登录
														</button>
													</div>
											...
											<center>
    <script type="text/javascript" src="http://qzonestyle.gtimg.cn/qzone/openapi/qc_loader.js" data-appid="101310984" data-redirecturi="http://1.1592502410.applinzi.com/insert.php" charset="utf-8"></script>
</center>
											</div>
										</div><!-- /widget-main -->
										...
										<div class="widget-main">
											...
											<form>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" class="form-control" placeholder="Email（邮箱）" />
															<i class="icon-envelope"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="Username（用户名）" />
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Password（密码）" />
															<i class="icon-lock"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Repeat password（确认密码）" />
...
<script>
    ...
    function check_name(){
        ...
        if(u_name==''){
            ...
            document.getElementById('s_name').innerHTML="<font color='red' style='font-size: 14px'>用户名不能为空 ！！</font>";
    ...
    function check_pwd(){
        ...
        if(u_pwd==''){
            ...
            document.getElementById('s_pwd').innerHTML="<font color='red' style='font-size: 14px'>密码不能为空 ！！</font>";
            document.getElementById('sp').disabled=true;
        }else{
